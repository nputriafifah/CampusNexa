  ...
  return (
    <div className="space-y-6">
      <PageHeader
        eyebrow="Super Admin"
        title="Profil"
        description="Data akun pengelola platform."
        action={
          !editing ? (
        ...
        <section className="overflow-hidden rounded-2xl border border-[var(--line)] bg-[#e8efea]">
          <div className="bg-[linear-gradient(135deg,#d5e8de_0%,#eef3f0_55%,#e8efea_100%)] px-6 pb-6 pt-7">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-full bg-[var(--forest-deep)] text-2xl font-bold text-white shadow-[0_8px_24px_rgba(15,92,76,0.25)]">
                {user?.avatar || 'S'}
              </div>
            ...
            {editing ? (
              ...
              <ul className="grid gap-3 sm:grid-cols-2">
                {[
                  ...
                  <li key={label} className="flex items-start gap-3 rounded-xl bg-[#f8faf9] px-4 py-3">
