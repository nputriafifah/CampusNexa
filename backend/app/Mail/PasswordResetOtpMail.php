...
class PasswordResetOtpMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Kode OTP reset kata sandi CampusNexa',
        );
    }
...
<body style="font-family: Georgia, serif; background:#eef3f0; padding:32px; color:#14201c;">
  <div style="max-width:480px; margin:0 auto; background:#fff; padding:28px 32px; border:1px solid #c9dbd3;">
    ...
    <p style="margin:0 0 12px;">Gunakan kode berikut untuk mengatur ulang kata sandi akun Anda:</p>
    ...
    <p style="margin:24px 0 0; font-size:13px; color:#8a9a93;">Jika Anda tidak meminta reset kata sandi, abaikan email ini.</p>
  </div>
</body>
</html>
HTML
